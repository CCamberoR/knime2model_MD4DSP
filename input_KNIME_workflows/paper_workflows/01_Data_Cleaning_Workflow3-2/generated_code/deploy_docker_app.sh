...
cp ../knime_dataDictionaries/binner_input_dataDictionary.csv "$(pwd)/data/"output
...
cp ../knime_dataDictionaries/rowFilterPrimitive_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/columnFilter_output_dataDictionary.csv "$(pwd)/data/"output
