...
def generateWorkflow():
	...
	data_smells.check_special_character_spacing(data_dictionary=rowFilterPrimitive_Airline__input_dataDictionary_df, field='Airline', origin_function="Row Filter")
