...
cp ../knime_dataDictionaries/mathOperation1_input_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mathOperation1_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mathOperation1_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mathOperation2_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mathOperation2_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/binner_output_dataDictionary.csv "$(pwd)/data/"output
