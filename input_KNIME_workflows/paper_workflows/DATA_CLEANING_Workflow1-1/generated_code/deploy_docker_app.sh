...
cp ../knime_dataDictionaries/mapping_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mapping_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mathOperation_output_dataDictionary.csv "$(pwd)/data/"output
