...
cp ../knime_dataDictionaries/mapping1_input_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mapping1_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mapping1_output_dataDictionary.csv "$(pwd)/data/"output
cp ../knime_dataDictionaries/mapping2_output_dataDictionary.csv "$(pwd)/data/"output
